...
import ClosePaneIcon from 'vue-material-design-icons/Close.vue'
  ...
  <div class="flex gap-x-8 gap-y-4 items-center ms-4 flex-wrap">
    ...
    <div>
      <h1 class="text-3xl font-semibold flex flex-wrap items-baseline">
        ...
        </span><span class="text-cyan-800 dark:text-cyan-200 font-normal">{{ explodedName[explodedName.length - 1] }}</span>
      </h1>
      <ul class="mt-2 flex gap-4 flex-wrap">
        <li
          v-for="result in sortedClassificationResults"
